...
var map = L.map('myMap').setView([39.75621,-104.99404], 5);
...
//create the style variable using color, weight, opacity parameter
var myStyle = {
    "color": "#ff7800",
    "weight": 5,
    "opacity": 0.65
...
//pass style config object with myLines geojson feature
L.geoJSON(myLines, {
    style: myStyle
}).addTo(map);
